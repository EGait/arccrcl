...
function SkeletonHero() {
  return (
    <div style={{ borderRadius: 20, overflow: 'hidden', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(227,200,150,0.1)' }}>
      <div style={{ height: 340, background: 'rgba(255,255,255,0.05)', animation: 'sf-shimmer 1.6s ease-in-out infinite' }} />
      <div style={{ padding: 32 }}>
        <div style={{ height: 10, width: 90, borderRadius: 4, background: 'rgba(227,200,150,0.15)', marginBottom: 16, animation: 'sf-shimmer 1.6s ease-in-out infinite' }} />
...
function SkeletonRow() {
  return (
    <div style={{ display: 'flex', gap: 14, padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      <div style={{ flex: 1 }}>
        <div style={{ height: 9, width: 60, borderRadius: 4, background: 'rgba(227,200,150,0.1)', marginBottom: 9, animation: 'sf-shimmer 1.6s ease-in-out infinite' }} />
    ...
    <>
      <style>{`
        ...
        .sf-hero-wrap {
          ...
          border-radius: 20px;
          overflow: hidden;
          border: 1px solid rgba(227,200,150,0.18);
          cursor: pointer;
        ...
        .sf-hero-wrap:hover {
          border-color: rgba(227,200,150,.55);
          box-shadow: 0 20px 60px rgba(0,0,0,.6), 0 0 0 1px rgba(227,200,150,.1);
        }
        .sf-hero-img {
        ...
        .sf-hero-no-img {
          ...
          background: linear-gradient(135deg, rgba(227,200,150,.08) 0%, rgba(227,200,150,.02) 100%);
          position: relative; overflow: hidden;
        }
        .sf-hero-no-img::after {
          content: '';
          position: absolute; inset: 0;
          background: repeating-linear-gradient(45deg,transparent,transparent 24px,rgba(227,200,150,.04) 24px,rgba(227,200,150,.04) 25px);
        }
        .sf-hero-gradient {
          position: absolute;
          bottom: 0; left: 0; right: 0;
          height: 65%;
          background: linear-gradient(to top, #0a1220 0%, rgba(10,18,32,.75) 50%, transparent 100%);
          pointer-events: none;
        }
        ...
        .sf-hero-wrap:hover .sf-hero-title { color: #E3C896; }
        .sf-read-cta {
          display: inline-flex; align-items: center; gap: 5px;
          font-size: 12px; font-weight: 600;
          color: #E3C896; letter-spacing: .04em;
        ...
        .sf-card-wrap:hover {
          border-color: rgba(227,200,150,.35);
        ...
        .sf-card-no-img {
          ...
          background: linear-gradient(135deg, rgba(227,200,150,.06) 0%, transparent 100%);
        }
        ...
        .sf-card-wrap:hover .sf-card-title { color: #E3C896; }
        ...
        .sf-row-no-thumb {
          width: 60px; height: 44px;
          border-radius: 7px;
          background: rgba(227,200,150,.06);
        ...
        .sf-row:hover .sf-row-title { color: #E3C896; }
        ...
        .sf-badge.own { color: #E3C896; background: rgba(227,200,150,.12); }
        .sf-badge.ct  { color: rgba(227,200,150,.6); background: rgba(227,200,150,.06); }
      ...
      <div style={{ padding: '48px 48px 80px', maxWidth: 1400 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 36 }}>
          <div style={{
            ...
            background: '#E3C896',
            boxShadow: '0 0 10px rgba(227,200,150,.7)',
            animation: 'sf-shimmer 2s ease-in-out infinite',
          }} />
          <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: '.12em', textTransform: 'uppercase', color: '#E3C896' }}>
            Latest News
          </span>
          <div style={{ flex: 1, height: 1, background: 'linear-gradient(90deg,rgba(227,200,150,.2) 0%,transparent 100%)', marginLeft: 8 }} />
        </div>
                ...
                {[...Array(3)].map((_,i) => (
                  <div key={i} style={{ borderRadius: 14, overflow: 'hidden', border: '1px solid rgba(255,255,255,.06)', background: 'rgba(255,255,255,.02)' }}>
                    ...
                    <div style={{ padding: 16 }}>
                      <div style={{ height: 9, width: 60, borderRadius: 4, background: 'rgba(227,200,150,.1)', marginBottom: 10, animation: 'sf-shimmer 1.6s ease-in-out infinite' }} />
                  ...
                  <div className="sf-hero-body">
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 13 }}>
                      <span className={`sf-badge ${hero.own ? 'own' : 'ct'}`}>
                        {hero.own ? 'ArcCRCL' : 'Cointelegraph'}
                      </span>
                    ...
                    <span className="sf-read-cta">
                      ...
                      <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                        <path d="M2.5 10.5L10.5 2.5M10.5 2.5H5.5M10.5 2.5V7.5" stroke="#E3C896" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </span>
                  </div>
                </a>
                      ...
                      <div className="sf-card-body">
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 9 }}>
                          <span className={`sf-badge ${article.own ? 'own' : 'ct'}`}>
                            {article.own ? 'ArcCRCL' : 'Cointelegraph'}
                          </span>
                  ...
                  {article.image ? (
                    ...
                    <div className="sf-row-no-thumb">
                      <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
                        <path d="M2 12L5.5 8L8 10.5L11 7L14 12H2Z" stroke="rgba(227,200,150,0.35)" strokeWidth="1.2" strokeLinejoin="round"/>
                        <circle cx="5" cy="5" r="1.5" stroke="rgba(227,200,150,0.35)" strokeWidth="1.2"/>
                      </svg>
                    </div>
                  )}
                  <div>

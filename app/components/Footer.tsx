export default function Footer() {
  return (
    <footer className="px-8 py-5 flex flex-col sm:flex-row justify-between items-center gap-3 border-t" style={{ borderColor: 'rgba(227,200,150,0.2)' }}>
      <div className="text-xs text-gray-700">© 2026 ArcCRCL · Built for the Arc ecosystem</div>
      <div className="flex gap-4 items-center flex-wrap justify-center">
        ...
        <span className="text-xs text-gray-700">@ArcCRCL</span>
      </div>
    </footer>
  )
}
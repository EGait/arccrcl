      ...
      <div className="max-w-2xl mx-auto px-6 md:px-8 py-12">
        ...
        <div className="flex flex-col gap-8 text-sm text-gray-400 leading-relaxed">
          <div>
            ...
            <p>Welcome to ArcCRCL ("we", "our", or "us"). We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our website and application at arccrcl.com.</p>
          </div>
          <div>
            <h2 className="text-base font-medium text-gray-200 mb-3">2. Information We Collect</h2>
            <p className="mb-3">ArcCRCL is a read-only news and DeFi tools platform. We collect minimal data:</p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-gray-500">
              <li>— To provide and improve the ArcCRCL platform</li>
          ...
          <div>
            ...
            <p>ArcCRCL may integrate with EVM-compatible wallets such as MetaMask and Ledger. When you connect your wallet, we only see your public wallet address. We do not store private keys, seed phrases, or have the ability to initiate transactions without your explicit approval in your wallet.</p>
          </div>
          <div>
            <h2 className="text-base font-medium text-gray-200 mb-3">5. Third Party Services</h2>
            <ul className="flex flex-col gap-2 text-gray-500">
              <li>— <strong className="text-gray-400">Third-party services</strong> — may power swaps and FX. Subject to their own privacy policies.</li>
          ...
          <div>
            ...
            <p>ArcCRCL may use cookies and local storage to remember your preferences and improve your experience. You can disable cookies in your browser settings at any time.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>ArcCRCL is not intended for users under the age of 18. We do not knowingly collect personal information from children.</p>
          </div>
          <div>
            <h2 className="text-base font-medium text-gray-200 mb-3">9. Changes to This Policy</h2>
            <p>We may update this Privacy Policy from time to time. We will notify users of significant changes by updating the date at the top of this page. Continued use of ArcCRCL after changes constitutes acceptance of the updated policy.</p>
          </div>
          <div>
            <h2 className="text-base font-medium text-gray-200 mb-3">10. Contact Us</h2>
            <p>If you have any questions about this Privacy Policy please contact us at <span style={{ color: '#E3C896' }}>hello@arccrcl.com</span></p>
          </div>
        </div>
      </div>

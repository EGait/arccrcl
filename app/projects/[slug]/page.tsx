      ...
      <div className="max-w-3xl mx-auto px-6 md:px-8 py-12">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            style={{ backgroundColor: 'rgba(227,200,150,0.1)', border: '1px solid rgba(227,200,150,0.2)' }}
          >
            ✕
          </button>
        </div>

        <div className="rounded-2xl p-8 mb-6" style={{ backgroundColor: 'rgba(227,200,150,0.05)', border: '1px solid rgba(227,200,150,0.2)' }}>
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl overflow-hidden" style={{ backgroundColor: 'rgba(227,200,150,0.1)' }}>
                {project.logo ? (
                  <img
                    src={project.logo}
                    alt={project.name}
            ...
            <div className="flex flex-col gap-3">
              {project.products.map((product: any, index: number) => (
                <div
                  ...
                  style={{ backgroundColor: 'rgba(227,200,150,0.03)', border: '1px solid rgba(227,200,150,0.12)' }}
                >
              ...
              {relatedProjects.map((related: any) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-8 h-8 rounded-lg flex items-center justify-center text-base overflow-hidden" style={{ backgroundColor: 'rgba(227,200,150,0.1)' }}>
                      {related.logo ? (
                        <img
                          src={related.logo}
                          alt={related.name}

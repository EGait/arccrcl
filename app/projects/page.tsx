...
const badgeStyles = {
  backgroundColor: 'rgba(227,200,150,0.1)',
  color: '#E3C896',
}
    ...
    <main className="bg-[#070c16] min-h-screen text-gray-100">
      ...
      <div className="px-6 md:px-8 py-12 border-b text-center" style={{ borderColor: 'rgba(227,200,150,0.2)' }}>
        ...
        <h1 className="text-3xl md:text-4xl font-medium mb-3">
          Top{' '}
          <span style={{ color: '#E3C896' }}>Arc Projects</span>
        </h1>
        <p className="text-gray-500 text-sm max-w-md mx-auto">
          Discover the best projects building on Arc — from stablecoin FX to payments to institutional finance.
        </p>
      </div>
      ...
      <div className="px-6 md:px-8 py-8">
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          <input
            ...
            style={{ border: '1px solid rgba(227,200,150,0.2)' }}
          />
            ...
            {categories.map((cat) => (
              <button
                ...
                style={activeCategory === cat ? {
                  backgroundColor: 'rgba(227,200,150,0.2)',
                  border: '1px solid rgba(227,200,150,0.5)',
                  color: '#E3C896',
                } : {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {featured.map((project: any) => (
                <div
                  ...
                  style={{ backgroundColor: 'rgba(227,200,150,0.05)', border: '1px solid rgba(227,200,150,0.2)' }}
                >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {rest.map((project: any) => (
                ...
                >
                  <div className="w-9 h-9 rounded-lg flex items-center justify-center text-base flex-shrink-0 overflow-hidden" style={{ backgroundColor: 'rgba(227,200,150,0.1)' }}>
                    {project.logo ? (
                      <img
                        src={project.logo}
                        alt={project.name}

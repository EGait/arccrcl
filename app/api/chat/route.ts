...
const SYSTEM_PROMPT = `
You are the assistant for ArcCRCL, a hub for Circle's Arc blockchain with news,
project discovery, and stablecoin FX rates. You help visitors navigate the
site and understand Arc.
...
async function callOpenRouter(
  ...
  const res = await fetch("https://openrouter.ai/api/v1/chat/completions", {
    ...
    headers: {
      ...
      "HTTP-Referer": "https://www.arccrcl.com",
      "X-Title": "ArcCRCL",
    },
    body: JSON.stringify({
      models,

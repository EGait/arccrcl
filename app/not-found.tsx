...
export default function NotFound() {
  ...
  return (
    <main className="bg-[#070c16] min-h-screen text-gray-100 flex items-center justify-center">
      <div className="text-center px-6">
        ...
        />
        <div className="text-6xl font-medium mb-4" style={{ color: '#E3C896' }}>
          404
        </div>
        ...
        <p className="text-gray-500 text-sm max-w-sm mx-auto mb-8">
          This page does not exist or has been moved. Head back to the homepage to explore Arc.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button
            onClick={() => router.push('/')}
            className="text-sm px-5 py-2 rounded-lg font-medium hover:opacity-90 transition-opacity"
            style={{ backgroundColor: '#E3C896', color: '#070c16' }}
          >
            Go home
          </button>
          <button

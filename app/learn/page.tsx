    ...
    <main className="bg-[#070c16] min-h-screen text-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 py-12">
        ...
        <h1 className="text-3xl font-medium text-gray-100 leading-snug mb-4">
          Arc <span style={{ color: '#E3C896' }}>101</span>
        </h1>

        <p className="text-gray-400 text-sm leading-relaxed mb-10 max-w-2xl">
          New to Arc? Start here. Plain-English guides on wallets, stablecoin basics, and getting around the ecosystem safely. No hype, no jargon, and nothing to buy. Just the basics done right.
        </p>
